...
# $ npm install
# only run above once, np if you do tho
...
def main():
    ...
    shutil.copytree('inbox_examples', 'inbox', ignore=shutil.ignore_patterns('\.git*'), dirs_exist_ok=True)
...
# $ tail -f data_files/messages.json
